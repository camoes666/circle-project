  ...
  return (
    <div className="space-y-1.5">
      ...
      <div className="relative">
        <div className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[#5e5e5e] pointer-events-none">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-3 bg-[#000000] border border-[#5e5e5e] rounded-[2px] text-white placeholder-[#757575] text-sm focus:outline-none focus:border-[#76b900] transition-colors"
        />
        {value && (
          <button
            type="button"
            onClick={() => onChange('')}
            className="absolute right-3 top-1/2 -translate-y-1/2 text-[#757575] hover:text-white transition-colors"
            aria-label="지우기"
          >
