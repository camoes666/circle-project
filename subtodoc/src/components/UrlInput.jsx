    ...
    <div className="space-y-1.5">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-3 bg-gray-800/60 border border-gray-700 rounded-xl text-gray-100 placeholder-gray-600 text-sm focus:outline-none focus:border-blue-500 focus:bg-gray-800 transition-colors"
        />
        {value && (
          <button
            type="button"
