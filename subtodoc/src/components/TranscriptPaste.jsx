    ...
    <div className="space-y-3">
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="space-y-0.5">
          <p className="text-sm font-bold text-white">자막 직접 붙여넣기</p>
          <p className="text-xs text-[#757575]">YouTube에서 자막을 복사해 아래에 붙여넣으세요</p>
        </div>
        <a
          href={bookmarkletHref}
          onClick={e => e.preventDefault()}
          title="북마크 바에 드래그해서 저장 후 YouTube 페이지에서 클릭"
          className="flex-shrink-0 flex items-center gap-1.5 px-2.5 py-1.5 bg-transparent border border-[#5e5e5e] rounded-[2px] text-xs text-[#a7a7a7] hover:border-[#76b900] hover:text-white transition-colors cursor-grab active:cursor-grabbing select-none"
          draggable="true"
        >
      ...
      {/* Steps */}
      <div className="flex gap-2 text-xs text-[#757575] bg-[#1a1a1a] border border-[#5e5e5e] rounded-[2px] px-3.5 py-2.5">
        <div className="space-y-1 leading-relaxed">
          <p><span className="text-[#a7a7a7] font-bold">1.</span> YouTube 영상 페이지에서 <span className="text-[#a7a7a7]">「⋯」→「자막 열기」</span> 클릭</p>
          <p><span className="text-[#a7a7a7] font-bold">2.</span> 위의 북마클릿을 북마크 바에 드래그 저장 후 클릭 (또는 전체선택 복사)</p>
          <p><span className="text-[#a7a7a7] font-bold">3.</span> 아래에 붙여넣기</p>
        </div>
      </div>
      ...
      <textarea
        ...
        rows={6}
        className="w-full px-4 py-3 bg-[#000000] border border-[#5e5e5e] rounded-[2px] focus:outline-none focus:border-[#76b900] text-white placeholder-[#757575] text-sm resize-y transition-colors"
      />

      {value && (
        <p className="text-xs text-[#757575] text-right">
