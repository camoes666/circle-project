    ...
    <div className="space-y-3">
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="space-y-0.5">
          <p className="text-sm font-medium text-gray-300">자막 직접 붙여넣기</p>
          <p className="text-xs text-gray-500">YouTube에서 자막을 복사해 아래에 붙여넣으세요</p>
        </div>
        <a
          href={bookmarkletHref}
          onClick={e => e.preventDefault()}
          title="북마크 바에 드래그해서 저장 후 YouTube 페이지에서 클릭"
          className="flex-shrink-0 flex items-center gap-1.5 px-2.5 py-1.5 bg-gray-800 hover:bg-gray-700 border border-gray-700/60 rounded-lg text-xs text-gray-400 hover:text-gray-200 transition-colors cursor-grab active:cursor-grabbing select-none"
          draggable="true"
        >
      ...
      {/* Steps */}
      <div className="flex gap-2 text-xs text-gray-600 bg-gray-800/40 rounded-xl px-3.5 py-2.5">
        <div className="space-y-1 leading-relaxed">
          <p><span className="text-gray-500 font-medium">1.</span> YouTube 영상 페이지에서 <span className="text-gray-400">「⋯」→「자막 열기」</span> 클릭</p>
          <p><span className="text-gray-500 font-medium">2.</span> 위의 북마클릿을 북마크 바에 드래그 저장 후 클릭 (또는 전체선택 복사)</p>
          <p><span className="text-gray-500 font-medium">3.</span> 아래에 붙여넣기</p>
        </div>
      </div>
      ...
      <textarea
        ...
        rows={6}
        className="w-full px-4 py-3 bg-gray-800/60 border border-gray-700 rounded-xl focus:outline-none focus:border-blue-500 text-gray-100 placeholder-gray-600 text-sm resize-y transition-colors"
      />
